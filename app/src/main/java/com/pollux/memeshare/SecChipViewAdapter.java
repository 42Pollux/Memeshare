...
public class SecChipViewAdapter extends ChipViewAdapter {
    public SecChipViewAdapter(Context context) {
        super(context);
    }
    ...
    public void onLayout(View view, int position) {
        ...
        ((TextView) view.findViewById(android.R.id.text2)).setTextColor(getColor(R.color.colorWhite));
        ((TextView) view.findViewById(android.R.id.text2)).setTextSize(16.0f);
